...
public class DatabaseWrapper {
	...
	// Cursor
	private EntityCursor<InvertedIndexEntity> inverted_cursor;
	

	
	public void traverseInverted() {
		inverted_cursor = invertedByIndex.entities();
		try {
			for (InvertedIndexEntity temp : inverted_cursor) {
				System.out.println(temp.getOriginalWord() + " : " + temp.getUrl());
			}
			// Always make sure the cursor is closed when we are done with it.
		} finally {
			inverted_cursor.close();
		}
	}

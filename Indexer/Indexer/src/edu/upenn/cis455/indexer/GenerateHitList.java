...
public class GenerateHitList {
	...
	public GenerateHitList(String html, String url) {
		this.html = html;
		this.url = url;
	...
	public GenerateHitList(String html, String url, int docId) {
		this.html = html;
		this.url = url;
		this.outcome = new HashMap<String, ArrayList<Hit>>();
		this.docId = docId;
	...
	private void generatePlainHitList() {

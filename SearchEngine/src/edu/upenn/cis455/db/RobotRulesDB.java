...
import edu.upenn.cis455.db.data.RobotExclusionBinding;
 ...
 *
 */
public class RobotRulesDB implements Closeable {

	public static final String TAG = RobotRulesDB.class.getSimpleName();
	...
	public RobotRulesDB(Environment env, DatabaseConfig config) {
